        ...
        <section className={` | bg-gradient-to-t from-gradients-background-light-royal-blue from-20% to-gradients-background-light-slate-blue md:basis-1/2 | rounded-b-[2.2rem] md:rounded-t-[2.2rem] | `}>
            {resultInfo.map((result) => (
                <div className={`pt-6 pb-10 | text-center | flex flex-col justify-center items-center | `}>
                    <h5 className={`mb-5 md:mb-10 | text-lg md:text-xl text-neutral-light-lavender font-medium |  | `}>
                        {result.resultTitle}
                    </h5>
                    ...
                    <h3 className={`mt-4 md:mt-6 mb-1 md:mb-3 | text-[1.6rem] md:text-[1.8rem] text-neutral-pale-blue font-bold |  | `}>
                        {result.resultGrade}
                    </h3>

                    <p className={`max-w-[20rem] md:max-w-[15.5rem] | text-lg leading-[1.5rem] text-neutral-light-lavender font-medium |  | `}>
